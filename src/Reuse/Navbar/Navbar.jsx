        ...
        <div className='flex items-center justify-between mx-2'>
          ...
          <div className='flex justify-end'>
            <div className='md:hidden' onClick={handleClick}>
              {
                show == true ? <RxCross1 className='text-3xl text-secondary' /> : <AiOutlineBars className='text-3xl text-secondary' />
              }
            </div>

            <div>
              <ul className={`md:flex py-2 md:gap-x-2 lg:gap-x-5 text-secondary bg-primary md:bg-opacity-0 z-10 justify-end duration-300 font-pop font-semibold text-bold
                          text-center absolute md:static w-full top-[-160px] ${show ? 'top-[65px] md:top-[210px] w-full left-0' : 'top-[-200px] left-0'}`}>
